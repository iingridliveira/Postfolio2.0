...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch("https://postfolio2-0.onrender.com/contact", {
      method: "POST",
      headers: {
    ...
    <section className="contact" id="connect">
      ...
      <Row className="align-items-center">
        ...
        <TrackVisibility>
          {({ isVisible }) =>
          <img className={isVisible ? "animate__animated animate__zoomIn" : ""} src={contactImg} alt="Imagem de contato"/>
          }
        </TrackVisibility>
        </Col>
        <Col size={12} md={6}>
